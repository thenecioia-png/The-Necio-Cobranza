...
export const getClient = async (
  id: number,
  options?: RequestInit,
): Promise<ClientWithLoans> => {
  return customFetch<ClientWithLoans>(getGetClientUrl(id), {
    ...options,
    method: "GET",
  });
};
 ...
 */
export const getGetTodayInstallmentsUrl = () => {
  return `/api/installments/today`;
};

export const getTodayInstallments = async (
  options?: RequestInit,
): Promise<InstallmentWithClient[]> => {
  return customFetch<InstallmentWithClient[]>(getGetTodayInstallmentsUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetTodayInstallmentsQueryKey = () => {
  return [`/api/installments/today`] as const;
};

export const getGetTodayInstallmentsQueryOptions = <
  TData = Awaited<ReturnType<typeof getTodayInstallments>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getTodayInstallments>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetTodayInstallmentsQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getTodayInstallments>>
  > = ({ signal }) => getTodayInstallments({ signal, ...requestOptions });
...
export type GetTodayInstallmentsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTodayInstallments>>
>;
export type GetTodayInstallmentsQueryError = ErrorType<unknown>;

/**
 * @summary Get all installments due today
 */

export function useGetTodayInstallments<
  TData = Awaited<ReturnType<typeof getTodayInstallments>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetTodayInstallmentsQueryOptions(options);
...
> => {
  ...
  > = (props) => {
    ...
    return payInstallment(id, requestOptions);
  };
...
export type PayInstallmentMutationError = ErrorType<ErrorResponse>;
